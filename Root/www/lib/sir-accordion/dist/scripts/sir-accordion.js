      ...
      var itemRegen = function(collection, parentIndex, currentIndex, level) {
		...
		if(parentIndex<1){
			...
			if(scope.config.menuLink!=''){
				...
				cutomTilte = '<a href="'+catLink+'" class="lev1"  >'+collection[currentIndex].title.toLowerCase()+"</a>";
			}else{
				cutomTilte = '<a href="#" class="lev1" '+collection[currentIndex].title.toLowerCase()+"</a>";
			}
		}
